...
The `pubid` is the article ID used by Google Scholar and it is the identifier
that used to retrieving citation history of the selected publication.
...
User can retrieving citation history of a particular publication using
